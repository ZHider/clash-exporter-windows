...
darwin-amd64:
	GOOS=darwin GOARCH=amd64 $(GOBUILD) -o $(NAME)-${VERSION}-$@
	tar czf $(NAME)-${VERSION}-$@.tar.gz $(NAME)-${VERSION}-$@
darwin-arm64:
	GOOS=darwin GOARCH=arm64 $(GOBUILD) -o $(NAME)-${VERSION}-$@
	tar czf $(NAME)-${VERSION}-$@.tar.gz $(NAME)-${VERSION}-$@
linux-amd64:
	GOOS=linux GOARCH=amd64 $(GOBUILD) -o $(NAME)-${VERSION}-$@
	tar czf $(NAME)-${VERSION}-$@.tar.gz $(NAME)-${VERSION}-$@
linux-arm64:
	GOOS=linux GOARCH=arm64 $(GOBUILD) -o $(NAME)-${VERSION}-$@
	tar czf $(NAME)-${VERSION}-$@.tar.gz $(NAME)-${VERSION}-$@
linux-armv6:
	GOOS=linux GOARCH=arm GOARM=6 $(GOBUILD) -o $(NAME)-${VERSION}-$@
	tar czf $(NAME)-${VERSION}-$@.tar.gz $(NAME)-${VERSION}-$@
linux-armv7:
